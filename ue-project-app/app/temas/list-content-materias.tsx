...
import { DetailContentMateria } from "./components/detail-content-materia";
...
export default function ListContentMaterias() {
    ...
    return (
            ...
            >
                ...
                <ThemedView style={stylesDashboard.contentInfoUser}>
                    ...
                    <ThemedText darkColor={ColorsButton.danger} lightColor={ColorsButton.danger} style={{ fontSize: 20, fontWeight: 'bold' }}>{loading === true ? <PlaceHolderText placeholder={PLACER_HOLDER_TEXT.medium} /> : '🎉 Lista de contenidos'}</ThemedText>
                </ThemedView>
                ...
                <ThemedView style={stylesDashboard.contentCardList}>
                    ...
                    renderItem={
                        ({ item }: any) => (
                            <>
                                <DetailContentMateria item={item} textButton="Ver Contenido" stylesDashboard={stylesDashboard} ColorsButton={ColorsButton} textButtonImportant={"Registrada"}/>
                            </>
                        )
                        } />
